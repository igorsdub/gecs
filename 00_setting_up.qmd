...
If WSL is not available from the Microsoft Store, proceed to @sec-wsl-installation-powershell below. If it is available, you might need to restart your computer after installing WSL.
:::
...
#### From the PowerShell {#sec-wsl-installation-powershell}
...
```         
https://gist.github.com/igorsdub/04f6a1191dde8e09091a1099fe87d5be.js
```
...
To verify that Pixi got installed successfully type:
