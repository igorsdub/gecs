...
Create `notebooks/visualize.py` in VS Code and add the initial interactive visualization:
...
::: {.callout-tip title="Terminal download fallback" collapse="true"}
You can also download this starter visualization script directly from the course assets:

```bash
curl -sSL https://raw.githubusercontent.com/oist/gecs/main/assets/notebooks/visualize.py -o notebooks/visualize.py
```
:::
...
- An interactive Altair bar chart displays the Top 30 most frequent words for that book.
