...
These files are executed every time you start a terminal. During the [setup process](/lessons/setting-up.qmd), you modified these files when installing tools like Pixi and Starship. For example, you added lines like:
